...
export default function TestimonialsSection() {
  return (
    <>
          ...
          <section className="py-20 md:py-32 bg-dark/80">
            <div className="container mx-auto px-6">
              <div className="max-w-4xl mx-auto text-center mb-16">
                <span className="text-xs uppercase tracking-widest text-neutral-400 mb-3 block reveal-up">Testimonials</span>
              ...
              <div className="minimal-slider" id="testimonialSlider">
                <div className="minimal-slider-track">
                  
                  <div className="minimal-slider-item px-4">
                    <div className="max-w-3xl mx-auto border border-neutral-800 rounded-sm p-8 md:p-12">
                      ...
                      <div className="flex items-center">
                        <div>
                          <div className="font-medium">Ashok Guri</div>
                          <div className="text-sm text-neutral-400">Founder, Raithumela</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="minimal-slider-item px-4">
                    <div className="max-w-3xl mx-auto border border-neutral-800 rounded-sm p-8 md:p-12">
                      ...
                      <div className="flex items-center">
                        <div>
                          <div className="font-medium">Best Trevor</div>
                          <div className="text-sm text-neutral-400">Managing Director, Majestic Developers</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="minimal-slider-item px-4">
                    <div className="max-w-3xl mx-auto border border-neutral-800 rounded-sm p-8 md:p-12">
                      ...
                      <div className="flex items-center">
                        <div>
                          <div className="font-medium">Amogh Vippili</div>
                          <div className="text-sm text-neutral-400">Instagram Promotions</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="minimal-slider-item px-4">
                    <div className="max-w-3xl mx-auto border border-neutral-800 rounded-sm p-8 md:p-12">
                      ...
                      <div className="flex items-center">
                        <div>
                          <div className="font-medium">Santosh</div>
                          <div className="text-sm text-neutral-400">Ananya Events</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="minimal-slider-nav flex justify-center mt-8">
                  <div className="minimal-slider-dot active" data-index="0"></div>
                  <div className="minimal-slider-dot" data-index="1"></div>
                  <div className="minimal-slider-dot" data-index="2"></div>
                  <div className="minimal-slider-dot" data-index="3"></div>
                </div>
              </div>
            </div>
          </section>
