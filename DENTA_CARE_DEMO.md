...
| URL | Purpose |
|-----|---------|
| **https://dentacare.crm.kaana.in** | Clinic desk (tenant subdomain) |
| **https://dentacare.clinic.kaana.in** | Same app (canonical clinic product URL) |
| **https://clinic.kaana.in?tenant=dentacare** | Works without wildcard DNS |
